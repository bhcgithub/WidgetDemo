...
public class CustomPopWindow implements PopupWindow.OnDismissListener{
    ...
    private PopWindowSelectCondition mPopupWindow;
    ...
    private PopupWindow build(){
        ...
        if(mWidth != 0 && mHeight!=0 ){
            mPopupWindow = new PopWindowSelectCondition(mContentView,mWidth,mHeight);
        }else{
            mPopupWindow = new PopWindowSelectCondition(mContentView, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        }
